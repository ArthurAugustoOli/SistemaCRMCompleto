...
if (!isset($_SESSION['login']) || $_SESSION['login'] !== 'Silvania') {
    header('Location: ../produtos/teste.php');
    exit;
}
...
if ($pagina_atual > $total_paginas) {
  header("Location: teste.php?page=" . $total_paginas);
  exit;
}
  ...
  <div class="main-content">
    ...
    <nav class="breadcrumb-nav" aria-label="breadcrumb">
      <ol class="breadcrumb mb-0">
        <li class="breadcrumb-item"><a href="teste.php"><i class="fas fa-home"></i></a></li>
        ...
        <div class="row stats-row">
          <div class="col-md-3 col-sm-6">
            <div class="stats-card animate__animated animate__fadeIn">
              ...
              <div class="stats-info">
                <h3 class="stats-value"><?php echo $totalDespesas; ?></h3>
                <p class="stats-label">Despesas Hoje</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-3 col-sm-6">
            <div class="stats-card animate__animated animate__fadeIn" style="animation-delay: 0.1s;">
              ...
              <div class="stats-info">
                <h3 class="stats-value">R$ <?php echo number_format($valorDespesasGerais, 2, ',', '.'); ?></h3>
          ...
          <div class="col-md-3 col-sm-6">
            <div class="stats-card animate__animated animate__fadeIn" style="animation-delay: 0.2s;">
              ...
              <div class="stats-info">
                <h3 class="stats-value"><?php echo count($produtosList); ?></h3>
...
<div class="mobile-nav">
  <a href="../produtos/teste.php" class="mobile-nav-item <?php echo $activePage == 'produtos' ? 'active' : ''; ?>">
    <i class="fas fa-box"></i>
    <span>Produtos</span>
  </a>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="teste.php?page=1" method="post" class="row g-3">
            <div class="col-md-6">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="teste.php?page=1" method="post">
...
<div class="modal fade" id="novaCompraModal" tabindex="-1" aria-labelledby="novaCompraModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="formNovaCompra" method="post" action="teste.php?page=compras&page=1">
  ...
  <div class="modal fade" id="editCompraModal" tabindex="-1" aria-labelledby="editCompraModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="teste.php?page=compras&page=1" method="post" class="row g-3">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="teste.php?page=compras&page=1" method="post">
...
$(function(){
  ...
  $('#id_produto').on('change', function() {
    ...
    if (produtoId) {
      $.get('teste.php', { action:'getVariacoes', produto:produtoId }, 'json')
  ...
  $('#editCompraModal').on('show.bs.modal', function(e) {
    ...
    $.get('teste.php', { action:'getCompra', id }, 'json')
     .done(compra => {
       ...
       $.get('teste.php', { action:'getVariacoes', produto:item.id_produto }, 'json')
        .done(vars => {
...
$(function(){
  ...
  $(document).on('change', '.produto-select', function(){
    ...
    if (!pid) return;
    $.get('teste.php', {action:'getVariacoes', produto:pid}, 'json')
     .done(vars => {
