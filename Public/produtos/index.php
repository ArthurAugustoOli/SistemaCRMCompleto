...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  switch ($action) {
    case 'show_value':
      ...
      // Em index.php, na parte “default” do switch($action):
    ...
    case 'store':
      ...
      if (!empty($_POST['codigo_barras'])) {
        ...
        if ($produtoExistente) {
          ...
          header("Location: index.php?msg=" . urlencode($mensagem) . "&msg_type=danger&error_duplicate=1");
          exit;
        }
      }
      ...
      if ($produtoModel->create($dados)) {
        ...
        header("Location: index.php?msg=Produto e variações criados com sucesso!&msg_type=success");
      } else {
        header("Location: index.php?msg=Erro ao criar produto!&msg_type=danger");
      }
      exit;
    ...
    case 'update':
      ...
      if (!$produtoModel->update($id_produto, $dados)) {
        header("Location: index.php?msg=Erro ao atualizar produto!&msg_type=danger");
        exit;
      }
    ...
    case 'add_stock':
      ...
      // redirect correto
      if ($id_variacao > 0) {
        header("Location: index.php?action=variacoes&id={$parentId}&msg=" . urlencode($msg) . "&msg_type={$msg_type}");
      } else {
        header("Location: index.php?msg=" . urlencode($msg) . "&msg_type={$msg_type}");
      }
      exit;
    ...
    case 'store_variacao':
      ...
      header("Location: index.php?action=variacoes&id=$id_produto&msg=" . urlencode($msg) . "&msg_type=$msg_type");
      exit;
  }
}
...
switch ($action) {
  case 'delete':
    if ($id_produto > 0) {
      if ($produtoModel->delete($id_produto)) {
        header("Location: index.php?msg=Produto excluído com sucesso!&msg_type=success");
      } else {
        header("Location: index.php?msg=Erro ao excluir produto!&msg_type=danger");
      }
    } else {
      header("Location: index.php?msg=ID de produto inválido!&msg_type=warning");
    }
    exit;
  ...
  case 'delete_variacao':
    if ($id_variacao > 0) {
      ...
      header("Location: index.php?action=variacoes&id=$id_produto&msg=$msg&msg_type=$msg_type");
    } else {
      header("Location: index.php?action=variacoes&id=$id_produto&msg=ID de variação inválido!&msg_type=warning");
    }
    exit;
}
...
<?php if ($msg): ?>
  <?php
    // Decide estilo e ícone conforme o tipo
    switch ($msg_type) {
      case 'success':
  ...
  <div class="modal fade" id="flashModal" tabindex="-1" aria-labelledby="flashModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header <?php echo $headerClass; ?>">
          <h5 class="modal-title" id="flashModalLabel">
            <i class="bi bi-<?php echo $icon; ?> me-2"></i><?php echo $title; ?>
          </h5>
          <button type="button" class="btn-close <?php echo ($msg_type!=='warning'?'btn-close-white':''); ?>"
        ...
        <div class="modal-footer">
          <button type="button"
                  class="btn <?php echo ($msg_type==='danger'?'btn-danger': ($msg_type==='warning'?'btn-warning':'btn-success')); ?>"
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      var bsModal = new bootstrap.Modal(flashModalEl);
      bsModal.show();
    });
  </script>
<?php endif; ?>
...
<body>
  ...
  <div class="app-container" id="appContainer">
    ...
    <div class="main-content mt-3">
      ...
      <div class="topbar">
        <div class="d-flex align-items-center gap-3">
          ...
          <form id="searchForm" method="GET" action="index.php" class="d-flex">
      ...
      <?php switch ($action):
        case 'create': ?>
          ...
          <div class="card fade-in-up" data-aos="fade-up">
            ...
            <div class="card-body">
              <form action="index.php?action=store" method="POST" enctype="multipart/form-data" class="needs-validation"
                novalidate>
                ...
                <div class="d-flex justify-content-end mt-4">
                  <a href="index.php" class="btn btn-outline-secondary me-2 hover-lift">
        ...
        case 'edit':
          ...
          if (!$produto) {
            ...
            echo '<a href="index.php" class="btn btn-primary hover-lift"><i class="bi bi-arrow-left"></i> Voltar para a lista</a>';
            break;
          }
        ?>
          ...
          <div class="card fade-in-up" data-aos="fade-up">
            ...
            <div class="card-body">
              <form action="index.php?action=update&id=<?php echo $id_produto; ?>" method="POST"
        ...
        ?>
          ...
          <div class="page-header" data-aos="fade-down">
            ...
            <a href="index.php" class="btn btn-outline-primary hover-lift">
                      ...
                      <?php foreach ($variacoes as $var): ?>
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            ...
                            <!-- Excluir -->
                            <a
                              href="index.php?action=delete_variacao&id=<?= $id_produto ?>&id_variacao=<?= $var['id_variacao'] ?>"
              ...
              <div class="card fade-in-up" data-aos="fade-left">
                ...
                <div class="card-body">
                  <form
                    id="form-variacao"
                    method="POST"
                    action="index.php?action=store_variacao&id=<?php echo $id_produto; ?>"
        ...
        ?>
          <div class="page-header" data-aos="fade-down">
            ...
            <a href="index.php?action=create" class="btn btn-primary hover-lift">
          ...
          <div class="d-md-none">
            ...
            <div class="mobile-actions">
              ...
              <div class="row g-2">
                <div class="col-6">
                  <a href="index.php?action=create" class="btn btn-primary w-100 py-3">
                          ...
                          <tr class="fade-in-up" data-aos="fade-up" data-aos-delay="<?php echo 50 * $prod['id_produto']; ?>">
                            ...
                            <td class="text-center">
                              <div class="d-inline-block text-center mx-1">
                                ...
                                <a href="index.php?action=edit&id=<?php echo $prod['id_produto']; ?>"
                              ...
                              <div class="d-inline-block text-center mx-1">
                                ...
                                <a href="index.php?action=variacoes&id=<?php echo $prod['id_produto']; ?>"
                      ...
                      <?php else: ?>
                        <tr>
                          <td colspan="6" class="text-center py-5">
                            ...
                            <a href="index.php?action=create" class="btn btn-primary pulse hover-lift">
                ...
                ?>
                  <div class="mobile-product-item">
                    ...
                    <div class="mobile-product-actions">
                      <a href="index.php?action=edit&id=<?php echo $prod['id_produto']; ?>" class="mobile-product-action-btn">
                        <i class="bi bi-pencil"></i>
                      </a>
                      <a href="index.php?action=variacoes&id=<?php echo $prod['id_produto']; ?>"
    ...
    <a href="index.php?action=create" class="fab d-flex justify-content-center align-items-center">
    ...
    <div class="modal fade" id="addStockModal" tabindex="-1" aria-labelledby="addStockModalLabel" aria-hidden="true">
      ...
      <script>
        ...
        addStockModal.addEventListener('show.bs.modal', function(event) {
          ...
          form.action = 'index.php?action=add_stock&id=' + produtoId;
      ...
      <script>
        document.getElementById('btnConfirmPassword').addEventListener('click', async () => {
          ...
          try {
            const res = await fetch('index.php?action=show_value', {
              method: 'POST',
      ...
      <script>
        ...
        addStockVarModal.addEventListener('show.bs.modal', event => {
          ...
          form.action = 'index.php?action=add_stock&id_variacao=' + varId;
          // limpa campos
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadVariationEdit(idVariacao) {
      ...
      fetch(`index.php?ajax_variacao=1&id_variacao=${idVariacao}`)
        .then(r => r.json())
        .then(data => {
      ...
      (function() {
        ...
        input.addEventListener('input', () => {
          ...
          debounceTimer = setTimeout(() => {
            ...
            fetch(`index.php?ajax_search=1&term=${encodeURIComponent(term)}`)
              .then(res => res.json())
              .then(data => {
                // esvazia tabela
                tableBody.innerHTML = '';
                ...
                <td class="text-center">
                  <a href="index.php?action=edit&id=${prod.id_produto}" class="btn btn-sm btn-warning me-1"><i class="bi bi-pencil"></i></a>
                  <a href="index.php?action=variacoes&id=${prod.id_produto}" class="btn btn-sm btn-info me-1"><i class="bi bi-tags"></i></a>
